...
def branch_and_bound_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, BranchAndBoundQeue())

def branch_and_bound_with_Subest_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, BranchAndBoundQeueWithSubest(problem))
